...
if __name__ == "__main__":
    ...
    #TextDataToCTF(trainFileName,"TrainData_120.ctf",False)
    #print("Train Data conversion is done")
    #TextDataToCTF(validationFileName,"ValidationData_120.ctf",False)
    #print("Validation Data conversion is done")
    TextDataToCTF(EvaluationFileName,"EvaluationData2_120.ctf",True)
